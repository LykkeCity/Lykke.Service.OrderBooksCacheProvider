...
using Lykke.Job.OrderBooksCacheProvider.Modules;
...
namespace Lykke.Job.OrderBooksCacheProvider
{
    public class Startup
    {
        ...
        private const string ApiTitle = "OrderBooksCacheProvider";
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, IApplicationLifetime appLifetime)
        {
            try
            {
                ...
                app.UseLykkeMiddleware(ApiTitle, ex => new ErrorResponse { ErrorMessage = "Technical problem" });
